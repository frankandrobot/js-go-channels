    ...
    case cPutRequest:
      {
        ...
        if (consumer) {
          nextTick(iterator);
          nextTick.apply(undefined, babelHelpers.toConsumableArray(_createConsumerMessage(consumer, { value: _msg2, done: false }, { chanId: chanId })));
        } else {
    ...
    case cCloseRequest:
      {
        ...
        while (_consumer) {
          nextTick.apply(undefined, babelHelpers.toConsumableArray(_createConsumerMessage(_consumer, { value: undefined, done: true }, { chanId: chanId })));
